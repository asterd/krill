...
- [M7 - Baseline Product Completion + Direct Skill and Operational Runtime](/Users/ddurzo/Development/python/krill/docs/spec/milestones/M7.md)
- [M7.5 - Channel Completion + HITL Product Flows + Operational Connectors](/Users/ddurzo/Development/python/krill/docs/spec/milestones/M7.5.md)
- [M8 - Skill OS Intelligence: Graph Planner + Capability Retrieval + Nested Runtime](/Users/ddurzo/Development/python/krill/docs/spec/milestones/M8.md)
...
- M7: baseline product completion on current channel/runtime surface, direct skills, schedules, and governed operational flows
- M7.5: dedicated channel adapters + HITL/resume product flows + operational connectors
- M8: advanced Skill-OS execution intelligence (graph planning + capability retrieval + composable nested runtime)
